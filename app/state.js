...
(() => {
    ...
    const elements = {
        ...
        reattachFolderBanner: queryOptional("#reattach-folder-banner"),
        reattachFolderButton: queryOptional("#reattach-folder-button"),
        ...
        imageReattachPrompt: queryOptional("#image-reattach-prompt"),
        imageReattachButton: queryOptional("#image-reattach-button"),
