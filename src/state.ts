...
const elements: ElementsRegistry = {
  ...
  sourceModeSelect: query<HTMLSelectElement>("#source-mode-select"),
  ...
  recentArchivesList: query<HTMLElement>("#recent-archives-list"),
  ...
  listPageInputTop: query<HTMLSelectElement>("#list-page-input-top"),
  ...
  reattachFolderBanner: queryOptional<HTMLElement>("#reattach-folder-banner"),
  reattachFolderButton: queryOptional<HTMLButtonElement>("#reattach-folder-button"),
  ...
  conversationDetailActions: query<HTMLElement>("#conversation-detail-actions"),
  loadConversationDetails: query<HTMLButtonElement>("#load-conversation-details"),
  conversationDetailStatus: query<HTMLElement>("#conversation-detail-status"),
  ...
  imageReattachPrompt: queryOptional<HTMLElement>("#image-reattach-prompt"),
  imageReattachButton: queryOptional<HTMLButtonElement>("#image-reattach-button"),
